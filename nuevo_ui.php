...
<html lang="es">
    ...
    <div class="col s1 m4 offset-m4">
		...
		<div class="card-action teal lighten-1 white white-text" ALIGN="justify">
				<h4 style="text-align:center">Registro de Usuario Intermedio</h4>
			</div>
			
			<div class="card-content">
			<form class="form-horizontal" method="post" action="guardar_ui.php" autocomplete="off" enctype="multipart/form-data">
